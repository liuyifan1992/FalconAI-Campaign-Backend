...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, email, first_name, last_name, password=None):
        falcon_ai_user = self.create_user(email, first_name, last_name, password=password)
...
class AIEmail(models.Model):
    ...
    email_topic = models.CharField(max_length=500, null=False)
    sender = models.ForeignKey(FlaconAIUser, null=False, on_delete=models.PROTECT)
    recipient = models.ForeignKey(Employee, null=False, on_delete=models.PROTECT)
